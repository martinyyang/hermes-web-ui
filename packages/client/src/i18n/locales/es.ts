export default {
  ...
  changelog: {
    ...
    new_0_4_8_7: 'Fix login token validation using Hermes session endpoint',    new_0_4_7_1: 'Visualizacion en streaming en tiempo real de bloques de pensamiento/razonamiento',
