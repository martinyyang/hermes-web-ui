export default {
  ...
  changelog: {
    ...
    new_0_4_8_7: 'Fix login token validation using Hermes session endpoint',    new_0_4_7_1: 'Affichage en streaming en temps reel des blocs de reflexion/raisonnement',
